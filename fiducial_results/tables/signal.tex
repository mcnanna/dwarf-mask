...
\tablehead{
\colhead{(1)} & \colhead{(2)} & \colhead{(3)} & \colhead{(4)}\hspace{0.35in} & \colhead{(5)} & \colhead{(6)} & \colhead{(7)} & \colhead{(8)} & \colhead{(9)} & \colhead{(10)} & \colhead{(11)} \\
 \colhead{Name} & \colhead{$\sqrt{\mathrm{TS}}$} & \colhead{SIG} & \colhead{$P_{\rm det}$}\hspace{0.35in} & \colhead{RA} & \colhead{Dec} & \colhead{$m - M$} & \colhead{Distance} & \colhead{$r_h$} & \colhead{$M_V$} & \colhead{Ref.} \\
 \colhead{} & \colhead{} & \colhead{} & \colhead{} & \colhead{(deg)} & \colhead{(deg)} & \colhead{} & \colhead{(kpc)} & \colhead{($'$)} & \colhead{(mag)} & \colhead{}  }
\startdata
\multicolumn{11}{c}{ DES Y3 A2 }\\
...
Tucana IV\tablenotemark{a} & 16.0 & 10.9 & 0.91 & 0.73 & -60.85 & 18.4 & 48 & 9.1 & -3.5 & 4\\
...
\hline
\multicolumn{11}{c}{ PS1 DR1 }\\
Leo I\tablenotemark{b} & 157.6 & 37.5 & 1.00 & 152.12 & 12.31 & 22.1 & 258 & 3.6 & -11.8 & 1\\
Leo II\tablenotemark{b} & 104.1 & 37.5 & 1.00 & 168.37 & 22.15 & 21.8 & 233 & 2.5 & -9.7 & 1\\
...
Leo IV\tablenotemark{c} & 8.2 & 4.9 & 0.02 & 173.24 & -0.53 & 20.9 & 154 & 2.5 & -5.0 & 1\\
...
Columba I\tablenotemark{c}\tablenotemark{d} & 6.1 & 5.3 & 0.00 & 82.86 & -28.03 & 21.3 & 183 & 1.9 & -4.5 & 3\\
Bootes II & 6.0 & 6.5 & 0.04 & 209.50 & 12.85 & 18.1 & 42 & 3.2 & -2.9 & 1\\
Bootes III & 5.6 & 4.7 & 1.00 & 209.30 & 26.80 & 18.4 & 47 & \ldots & -5.8 & 3\\
Bootes IV\tablenotemark{c} & 5.4 & 4.7 & \ldots & 233.69 & 43.73 & \ldots & \ldots & \ldots & \ldots & \ldots\\
