...
\colhead{(1)} & \colhead{(2)} & \colhead{(3)} & \colhead{(4)} & \colhead{(5)} & \colhead{(6)} & \colhead{(7)} & \colhead{(8)} & \colhead{(9)} & \colhead{(10)} & \colhead{(11)} & \colhead{(12)} \\
 \colhead{Name} & \colhead{$\sqrt{\mathrm{TS}}$} & \colhead{SIG} & \colhead{$P_{\rm det}$} & \colhead{RA} & \colhead{Dec} & \colhead{$m - M$} & \colhead{$r_{1/2}$} & \colhead{Distance} & \colhead{$r_{1/2}$} & \colhead{$M_V$} & \colhead{Ref.} \\
